...
<div class="loginDetails">
    <br/>
    <form method="POST" action="DS-Signin.php">
        <label class="heading">DVD Store Admin - Sign in</label><br/><br/>
        <br/>
        <div class="details">
...
<?php
    ...
    if(isset($_POST["btnsignin"]))
    {
        ...
        else
        {
            ...
            $_SESSION["account"]=$rowUserPass["accounttype"];

            if ($username == $rowUserPass["username"] && $password == $rowUserPass["password"])
            {
                if(!($rowUserPass["accounttype"]=="Administrator"))
                {
                    header("location: index.php");
                }
                else
                {
                    header("location: DS-DashboardIntro.html");
                }
            }
            else
            {
