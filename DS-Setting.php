...
<head>
    ...
    <style>
        ...
        .dropdownform input[type=submit]
        {
            border:1px solid white;
            outline:none;
            color:white;
        ...
        .dropdownform input[type=submit]:hover
        {
            background-color: white;
            color:black;
        }
...
<body>
<div class="navitop">
    <label style="float:left;margin-left:15%;font-size:18px">Setting</label>
...
<div class="main">
    <h4>Hey <?php echo $_SESSION["loginuser"];?>!, you can customize your settings...</h4>
    <hr/>
    <a href="DS-Customer.php"><div class="detail users" style="background-color: teal">
            <h5>Customer Details<br/>User Details</h5>
        </div></a>
    <a href="#" id="usersRemove"><div class="detail stocks" style="background-color: seagreen">
            <h5>Remove Users</h5>
        </div></a>
    <div id="dropdown" class="dropdown">
        <form method="POST" action="DS-Setting.php" class="dropdownform">
    ...
    <?php
        ...
        if(isset($_POST["btnremove"]))
        {
            ...
            {
                $removeUser = "DELETE FROM user_registration WHERE username = '$uname'";

                if ($con->query($removeUser))
                {
                    echo '<script>';
...
?>
    <div class="sidenav" id="mySidenav">
        ...
        <form class="formi" method="POST" action="DS-Setting.php">
